...
class IdentityViewModel(
    ...
    fun onContinue() {
        ...
        _state.update { copy(isLoading = true, isContinueButtonEnabled = false) }
        viewModelScope.launch {
            val sessionId = try {
                ...
                _state.update { copy(isLoading = false, isContinueButtonEnabled = true) }
            }
    ...
    class Factory(
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            ...
            return IdentityViewModel(repository) as T
        }
    }
}
